...
/* ── Phased API (non-blocking, for async pressure state machine) ── */

bool ms5607_start_d1(void) {
    return ms5607_write_cmd(MS5607_CMD_CONV_D1);
}

bool ms5607_start_d2(void) {
    return ms5607_write_cmd(MS5607_CMD_CONV_D2);
}
...
bool ms5607_compensate(uint32_t d1, uint32_t d2, pressure_reading_t *out) {
    int32_t dT = (int32_t)d2 - ((uint32_t)prom[5] << 8);
