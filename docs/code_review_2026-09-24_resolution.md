...
| N18 | LANDED's 1 Hz logging never fires (already defect 9 in flight_states.md). | **Fixed** (2026-09-26): timed on its own; `test_N18_landed_logs_once_a_second`. |
