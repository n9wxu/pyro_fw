# ── Simulated Pyro MK1A ────────────────────────────────────────────────
#
# A host board that runs the REAL MK1A pyro backend against a model of the
# MK1A board. boards/sim runs the flight software with a pyro fixture, where
# continuity is whatever a test last wrote; this runs it with
# boards/mk1a/pyro_board.c driving sim/plant/plant_mk1a.c through the Pico SDK
# stand-in in sim/hw/.
#
...
#
#     cmake -B build-sim-mk1a -DPYRO_BOARD=sim_mk1a && cmake --build build-sim-mk1a --target sim

set(PYRO_BOARD_KIND host)
set(PYRO_HAS_LUA 0)   # the pyro model is the point here; Lua is boards/sim's job
set(BOARD_DISPLAY_NAME "Pyro MK1A (simulated board)")
