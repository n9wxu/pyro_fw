...
NEW_FIELDS = ("pyro1_refused", "pyro2_refused", "pyro1_refires", "main_forced", "usb_attached", "test_mode",
              ...
              "sample_interval_us", "stamp_lag_max_us", "fit_sigma_mpa")
...
# T5: the fit's noise, measured on the pad, between the datasheet's floor and the ceiling.
check("status: fit_sigma_mpa is the pad's measured noise", 1200 <= st0.get("fit_sigma_mpa", 0) <= 5000,
      str(st0.get("fit_sigma_mpa")))
